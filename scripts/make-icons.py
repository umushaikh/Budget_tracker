...
image libraries required. Draws a rounded-square background with a "budget
ring" motif — the same progress-ring shape the in-app gauge uses — so the
home-screen icon echoes the app itself, with a coin-gold dot standing in for
the money at its center.
"""
import math
import struct
import zlib

BG = (13, 92, 58)        # deep money-green
RING = (255, 255, 255)   # white
DOT = (245, 197, 66)     # coin gold
